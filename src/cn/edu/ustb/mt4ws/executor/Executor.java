...
public class Executor implements Callable<Statistic> {
	...
	public Statistic runTestCaseSerial() throws Exception {
...
//								operationName, inputFollow, null);
						...
						//modified by wendy 20130616
						XmlTestCase testcaseFollow = tcGen.extractFromDB_F(opFormat, mrId, testcaseId);						
						...
						List<String> outputFollowUpQuake = new ArrayList<String>();
							...
							if (operationName.equals("transfer")
									...
									|| operationName.equals("process")
									|| operationName.equals("add")
									|| operationName.equals("sub")
									|| operationName.equals("checkQuantity")) {
								outputSource = tcGen.parseSoapResponse(
										opFormat, responseSource);
								addTestingLog("Parsing Response of FOLLOW-UP Test Case...");
								outputFollowUp = tcGen.parseSoapResponse(
										opFormat, responseFollow);
							} else if (operationName.equals("matchQuakes")) {
								outputSourceQuake = tcGen
										.parseSoapResponseQuake(responseSource);
								addTestingLog("Parsing Response of FOLLOW-UP Test Case...");
								outputFollowUpQuake = tcGen
										.parseSoapResponseQuake(responseFollow);
							}
